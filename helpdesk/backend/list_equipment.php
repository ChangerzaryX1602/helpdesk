...
<?php include('modal/form-add-modal.php');?>
		<div style="margin-bottom:14px;">
			<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#add_equipment">
				<i class="fa fa-plus-circle"></i> เพิ่มอุปกรณ์
			</button>
		</div>
          <div class="box">
            <div class="box-header text-center bg-blue">
              <h3 class="box-title"><i class="fa fa-desktop" style="margin-right:7px;"></i>จัดการข้อมูลอุปกรณ์</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
