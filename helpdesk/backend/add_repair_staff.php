...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <form name="form_repair" method="post" action="action/action_insert_repair_staff.php">
            <div class="box">
              <div class="box-body">
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select name="u_idcard" class="form-control" required>
                        <option value="">เลือกผู้แจ้งซ่อม</option>
                        <?php
                        $userQuery = mysqli_query($conn, "SELECT * FROM tb_user ORDER BY u_fname ASC");
                        while ($user = mysqli_fetch_array($userQuery)) {
                        ?>
                          <option value="<?php echo $user['u_idcard']; ?>">
                            <?php echo $user['u_prefix'] . $user['u_fname'] . ' ' . $user['u_lname']; ?>
                          </option>
                        <?php } ?>
                      </select>
                    </div>
