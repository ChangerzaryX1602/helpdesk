...
<?php include('modal/form-add-modal.php');?>
		<div style="margin-bottom:14px;">
			<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#add_position">
				<i class="fa fa-plus-circle"></i> เพิ่มตำแหน่ง
			</button>
		</div>
          <div class="box">
            <div class="box-header text-center bg-blue">
              <h3 class="box-title"><i class="fa fa-id-badge" style="margin-right:7px;"></i>จัดการข้อมูลตำแหน่ง</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                                <table id="example" width="100%" class="table table-hover">
									...
									?>	
                                    	<tr>
											...
											<td>
                                            	<button type="button" class="btn btn-success btn-sm btn-icon" data-toggle="modal" data-target="#editPositionModal<?php echo $rows['p_id'];?>"><span class="fa fa-edit"></span></button>
                                            </td>
                                            <td>
                                            	<button type="button" class="btn btn-warning btn-sm btn-icon" data-toggle="modal" data-target="#deletePositionModal<?php echo $rows['p_id'];?>"><span class="fa fa-trash"></span></button>
                                            </td>
                                        </tr>
                                    <?php $i++; } ?>
                                    </tbody>
